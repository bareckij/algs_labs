...
input = open('task9/txtf/input.txt').readline().strip().split()
...
open('task9/txtf/output.txt', 'w').write(''.join(map(str, add_two_binary(first_number_from_list, second_number_from_list))).lstrip('0') or '0')
